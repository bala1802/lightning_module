...
import torch
from lightning.pytorch.callbacks import LearningRateFinder, LearningRateMonitor, RichProgressBar

def auto_find_lr_and_fit(model: pl.LightningModule,
                        datamodule: pl.LightningDataModule,
                        trainer_args: dict,
                        lr_finder_args: dict = {},
                        save_traced_model: bool = False,
                        input_shape: tuple = (1, 3, 32, 32)) -> Any:
    callbacks = [
